...
const SystemEventSeverityQuerySchema = z.enum([
  "debug",
  "info",
  "warning",
  "error",
...
const SystemEventCategoryQuerySchema = z.enum([
  "workflow",
  "agent",
  "system",
  "integration",
...
const SystemEventIdentifierSchema = z.string().trim().min(1).max(100);

export const SystemEventsQuerySchema = z.object({
  severity: SystemEventSeverityQuerySchema.optional(),
  agent_name: SystemEventIdentifierSchema.optional(),
  event_type: SystemEventIdentifierSchema.optional(),
  event_category: SystemEventCategoryQuerySchema.optional(),
  workflow_id: SystemEventIdentifierSchema.optional(),
  correlation_id: SystemEventIdentifierSchema.optional(),
